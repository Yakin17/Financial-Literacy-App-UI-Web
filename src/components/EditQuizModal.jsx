...
function EditQuizModal({ quiz, articles, onClose, onSave }) {
    ...
    // Initialiser le formulaire avec les données du quiz existant
    useEffect(() => {
        if (quiz) {
            setFormData({
                articleId: quiz.articleId,
                question: quiz.question,
                reponseCorrecte: quiz.reponseCorrecte,
                reponseInc1: quiz.reponseInc1,
                reponseInc2: quiz.reponseInc2,
                reponseInc3: quiz.reponseInc3
            });
        }
    }, [quiz]);
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-2xl">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold text-gray-800">Modifier le quiz</h2>
                    <button
                        onClick={onClose}
